...
[From the desire github repo](https://github.com/desirepay/desire/blob/master/doc/masternode_conf.md)
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `desire.conf` file.
...
and comparing with the official explorer at https://explorer.desire.org/chain/Desire
