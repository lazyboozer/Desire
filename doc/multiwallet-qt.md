...
Only requiring some minor changes is desire.cpp.
...
Changes to desire.cpp
----------------------
desire.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
