...
This mechanism has been integrated into Bitcore-Node-Desire which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/desirepay/insight-api-desire#web-socket-api](https://github.com/desirepay/insight-api-desire#web-socket-api)
* API: [https://github.com/desirepay/insight-api-desire#instantsend-transactions](https://github.com/desirepay/insight-api-desire#instantsend-transactions)
...
By default, the Desire Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Desire Core daemon:
