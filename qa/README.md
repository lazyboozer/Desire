...
Every pull request to the Desire Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing desired/desire-cli
                        (default: ../../src)
...
blocks (25*500=12500 DSR) in its wallet.
