...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DesireNetwork") type = DesireNetwork;
    if(strType == "DesireNetworkVariable") type = DesireNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DesireNetwork) s = "DesireNetwork";
    if(type == DesireNetworkVariable) s = "DesireNetworkVariable";
