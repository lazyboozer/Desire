    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DSR-light"), QVariant("light"));
    ui->theme->addItem(QString("DSR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DSR-Crownium"), QVariant("crownium"));
