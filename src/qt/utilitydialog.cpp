    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Desire Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Desire Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  desire-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Desire in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DSR, 0.1 DSR, 1 DSR and 10 DSR -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Desire Core is shutting down...") + "<br /><br />" +
