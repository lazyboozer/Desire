    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Desire Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Desire address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and desire: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Desire Core"), this);
    aboutAction->setStatusTip(tr("Show information about Desire Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Desire Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Desire addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Desire addresses"));
    ...
    openAction->setStatusTip(tr("Open a desire: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Desire Core help message to get a list with possible Desire Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Desire Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Desire network", "", count));
    } else {
...
{
    QString strTitle = tr("Desire Core"); // default title
