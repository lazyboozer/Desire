...
{
    if(fLiteMode) return; // ignore all Desire related functionality
...
/*
    ...
    allow endless transaction that would bloat Desire and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("desire-privatesend");
